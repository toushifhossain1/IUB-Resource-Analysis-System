        ...
        <div class="home-content">
            ...
            <table class="button6">
                ...
                echo "<tr><th></th><th></th><th></th>
                        <th>" . "$semester1" . " " . "$semester_year1" . "</th><th></th><th></th><th></th><th></th>
                ...
                for ($i = 1; $i <= 60; $i++) {
                    //SPRING
                    for ($j = 0; $j < 4; $j++) {
                        $sql = "SELECT COUNT(*) FROM section_t WHERE school_title= '$school_name[$j]' AND semester_name='$semester1' AND semester_year='$semester_year1' AND std_enrolled ='$i';";
                    ...
                    // //SUMMER
                    for ($l = 0; $l < 4; $l++) {
                        $sql2 = "SELECT COUNT(*) FROM section_t WHERE school_title= '$school_name[$l]' AND semester_name='$semester2' AND semester_year='$semester_year2' AND std_enrolled ='$i';";
