    ...
    <section class="home-section">
        ...
        <div class="home-content">
            <table class="button_1">
                ...
                echo "<tr><th></th>
        <th >" . "$semester1" . " " . "$semester_year1" . "</th><th></th><th></th>
    ...
    <tr>
        ...
        <th>Class room 7</th>
                ...
                for ($i = 0; $i < count($cls_size1); $i++) {
                    ...
                    semester_name='$semester1' AND semester_year='$semester_year2' AND roomcapacity BETWEEN $cls_size1[$i] AND $cls_size2[$i];";
